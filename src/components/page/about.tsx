...
export default function About() {
  ...
  return (
    <div id="about" className="flex flex-row items-center justify-center my-[5%] mx-[7%]">
        ...
        <div className="w-1/2 relative h-[100vh] rounded-b-[3rem] overflow-hidden" data-aos="fade-left">
            <Image
                src="/about.jpeg"
                layout="fill"
                objectFit="cover"
